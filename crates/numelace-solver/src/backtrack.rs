...
//!
//! ```
//! use numelace_solver::{TechniqueGrid, backtrack};
//!
...
mod tests {
    ...
    fn test_find_best_assumption_selects_minimum_candidates() {
        ...
        grid.place(Position::new(0, 5), Digit::D6);
        grid.place(Position::new(0, 6), Digit::D7);
        ...
        grid.place(Position::new(1, 0), Digit::D4);
        grid.place(Position::new(1, 1), Digit::D5);
        grid.place(Position::new(1, 2), Digit::D6);
        grid.place(Position::new(2, 0), Digit::D7);
    ...
    fn test_find_best_assumption_panics_when_inconsistent() {
        ...
        let conflict_pos = Position::new(0, 1);
