...
use crate::{
    ...
    technique::{Technique, TechniqueApplication, TechniqueStep},
};

use super::{BoxedTechniqueStep, ConditionCells, ConditionDigitCells};
...
impl TechniqueStep for XWingStep {
    ...
    fn condition_digit_cells(&self) -> ConditionDigitCells {
        vec![(self.positions, DigitSet::from_elem(self.digit))]
    }
...
impl XWing {
    ...
    fn apply_with_control_flow<F>(
        ...
        mut on_condition: F,
    ) -> Result<Option<XWingStep>, SolverError>
    where
        F: for<'a> FnMut(
            &'a mut TechniqueGrid,
            Digit,
    ...
    fn find_step(&self, grid: &TechniqueGrid) -> Result<Option<BoxedTechniqueStep>, SolverError> {
        ...
        let step = Self::apply_with_control_flow(
            ...
            |after_grid, digit, (x1, x2), (y1, y2)| {
                ...
                ControlFlow::Break(XWingStep::new(digit, (x1, x2), (y1, y2), app))
            },
        )?;
