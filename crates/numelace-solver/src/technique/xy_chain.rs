...
mod tests {
    ...
    fn test_eliminates_xy_chain_candidates() {
        ...
        let elimination = Position::new(5, 1);
    ...
    fn test_eliminates_xy_chain_loop_candidates() {
        ...
        let elimination_start_end = Position::new(1, 3);
        let elimination_start_mid = Position::new(1, 2);
        let elimination_mid_end = Position::new(1, 7);
